        ...
        <React.Fragment>
          <Grid item xs={4}>
            <Paper className={classes.paper}>
              ...
              {coronaData.corona[0]["hospitalizedCurrently"]}
            </Paper>
          </Grid>
          <Grid item xs={4}>
            <Paper className={classes.paper}>
          ...
          <Grid item xs={4}>
            <Paper className={classes.paper}>
              ...
              {coronaData.corona[0]["onVentilatorCurrently"]}
            </Paper>
          </Grid>
        </React.Fragment>
      );
    ...
    function TestingStatsRow() {
      return (
        <React.Fragment>
          <Grid item xs={4}>
            <Paper className={classes.paper}>
              Total Positive Tests: {coronaData.corona[0]["positive"]}
            </Paper>
          </Grid>
          <Grid item xs={4}>
            <Paper className={classes.paper}>
              Total Negative Tests: {coronaData.corona[0]["negative"]}
            </Paper>
          </Grid>
          <Grid item xs={4}>
            <Paper className={classes.paper}>
              Currently Pending Tests: {coronaData.corona[0]["pending"]}
            </Paper>
          </Grid>
        </React.Fragment>
      );
